...
#musica_de_fundo = pygame.mixer.music.load('') #Passa o arquivo de audio. Só a musica de fundo pode ser mp3, WAV para outros sons.
#pygame.mixer.music.play(-1) #Dá play e o -1 faz com que reinicie.

#barulho_colisao = pygame.mixer.sound('(1).wav')
